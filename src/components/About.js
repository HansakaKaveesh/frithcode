...
export default function About() {
    ...
    return (
        <section className="py-12 px-6 md:px-20 bg-white dark:bg-gray-900 flex flex-col md:flex-row items-center gap-10">
            <div className="md:w-1/2 text-center md:text-left" data-aos="zoom-in">
                ...
                <div className="flex flex-col md:flex-row justify-start gap-8">
                    <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="300">
            ...
            <div className="md:w-1/2 flex justify-center mt-8 md:mt-0" data-aos="zoom-in">
            <Image 
                src={teamImage} 
