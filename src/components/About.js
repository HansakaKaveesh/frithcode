        ...
        <section className="py-12 px-6 md:px-20 bg-white dark:bg-gray-900 flex flex-col md:flex-row items-center gap-10">
            <div className="md:w-1/2 text-center md:text-left">
                ...
                <div className="flex flex-col md:flex-row justify-start gap-8">
                    <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-lg animate-fadeInUp transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                        <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">2024 Years in Business</h3>
                        <p className="text-gray-600 dark:text-gray-400">Since our inception, we have focused on quality and customer satisfaction, building lasting relationships with clients across various industries.</p>
                    </div>
                    <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-lg animate-fadeInUp transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                        <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">4 Core Values</h3>
                        <p className="text-gray-600 dark:text-gray-400">Integrity, Innovation, Customer Focus, and Collaboration are the pillars of our company culture, guiding us in every project we undertake.</p>
                    </div>
                </div>
            </div>
