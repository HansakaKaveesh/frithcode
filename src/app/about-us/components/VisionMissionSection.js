...
import { FaGlobe, FaBullhorn } from 'react-icons/fa'; // Import React Icons
import AOS from 'aos';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 text-center">
          ...
          <div className="transform hover:scale-105 motion-safe:animate-fadeIn">
            <div
              ...
              data-aos="zoom-in"
            >
              <h3 className="text-xl md:text-2xl font-bold text-blue-700 dark:text-blue-400 mb-6 flex justify-center items-center">
                <FaGlobe className="mr-2 text-3xl" /> {/* Add icon */}
                Our Vision
              </h3>
          ...
          <div className="transform hover:scale-105 motion-safe:animate-fadeIn">
            ...
            >
              <h3 className="text-xl md:text-2xl font-bold text-blue-700 dark:text-blue-400 mb-6 flex justify-center items-center">
                <FaBullhorn className="mr-2 text-3xl" /> {/* Add icon */}
                Our Mission
              </h3>
              <p className="text-base md:text-lg text-gray-600 leading-relaxed dark:text-gray-300">
